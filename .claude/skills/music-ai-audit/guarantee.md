...
## Intake (from the Cal.com booking)

Set these as required questions on the audit booking event so you walk in prepared:
...
6. Anything you've already tried to fix it? (free text)

That's enough to assemble the right ICP question set from `discovery-questions.md` before the call.
