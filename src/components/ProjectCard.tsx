...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  const renderBrowserFrame = (src: string, alt: string) => {
    return (
      <div className="w-full aspect-[16/10] flex flex-col bg-neutral-100 border-b-2 border-neutral-900 relative group overflow-hidden">
        {/* Browser Top Chrome bar */}
        <div className="bg-neutral-100 border-b border-neutral-350 py-1.5 px-3 flex items-center justify-between select-none shrink-0">
          <div className="flex gap-1">
            <span className="h-1.5 w-1.5 bg-neutral-300 rounded-full border border-neutral-400"></span>
            <span className="h-1.5 w-1.5 bg-neutral-300 rounded-full border border-neutral-400"></span>
            <span className="h-1.5 w-1.5 bg-neutral-300 rounded-full border border-neutral-400"></span>
          </div>
          <div className="bg-white border border-neutral-250 text-[7px] text-neutral-400 font-mono py-0.5 px-4 rounded-sm w-36 text-center truncate select-all">
        ...
        {/* Full-bleed screenshot container */}
        <div className="relative flex-grow w-full bg-neutral-50 overflow-hidden">
          <Image 
            ...
            priority={project.id === 'total-audio-promo'}
          />
        </div>
      </div>
    );
  ...
  const renderCardHeader = () => {
    switch (project.id) {
      case 'total-audio-promo':
        return renderBrowserFrame("/tap-ss3-home-dashboard.png", "Total Audio Promo dashboard screenshot");
      
      case 'totalaud-io':
        return renderBrowserFrame("/totalaud-onboarding-preview.png", "totalaud.io waitlist onboarding screenshot");

      case 'spotcheck':
        return renderBrowserFrame("/spotcheck_screenshot.png", "SpotCheck curator validation screenshot");

      case 'newsjack':
        return renderBrowserFrame("/newsjack_screenshot.png", "Newsjack curation feed screenshot");
...
{`   ___ (_)__  / /__
 ...
 /___/_/_//_/_/\\_\\`}
            ...
            <div className="space-y-1 my-0.5 text-neutral-350">
              <div className="text-neutral-500 font-bold text-[7px]">$ sink wash list.csv</div>
        ...
        return (
          <div className="w-full aspect-[16/10] bg-[#0b0c10] text-[#45f3ff] p-3 font-mono text-[8px] flex flex-col justify-between select-none leading-[1.1] border-b-2 border-neutral-900">
            ...
            <div className="space-y-1 my-1">
              <div className="text-neutral-500 font-bold border-b border-neutral-900 pb-0.5 text-[7px] flex justify-between">
      ...
      <div className="p-5 flex-grow flex flex-col justify-between space-y-4">
        <div>
          ...
          <div className="mt-4 space-y-2">
            <p className="text-neutral-500 text-xs italic tracking-wide font-sans">{project.tagline}</p>
